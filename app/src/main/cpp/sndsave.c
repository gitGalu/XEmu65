...
int SndSave_OpenSoundFile(const char *szFileName) {
    ...
    */
    ...
    write32(POKEYSND_playback_freq *
            (POKEYSND_snd_flags & POKEYSND_BIT16 ? POKEYSND_num_pokeys << 1 : POKEYSND_num_pokeys));

    fputc(POKEYSND_snd_flags & POKEYSND_BIT16 ? POKEYSND_num_pokeys << 1 : POKEYSND_num_pokeys,
          sndoutput);
    fputc(0, sndoutput);
